...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function processarComandoDeVoz(comando) {
        try {
            ...
            valorAtual = String(resultado);
            falar(` ${comando}, igual a ${resultado}`); // falar resultado
            atualizarVisor();
        ...
        // Cria uma versão do comando que foi ouvido para ser falada de forma mais natural
            let comandoFalado = comando.toLowerCase().replace(/x/g, 'vezes');
            
            valorAtual = String(resultado);
            // Usa a nova variável "comandoFalado" aqui na resposta
